...
public class ManagerHome extends javax.swing.JPanel {
    ...
    public void init(SQLite sqlite, String username){
        ...
        this.currentUserRole = 4; // Manager role
    ...
    private boolean checkManagerAccess(String username, int userRole, String action) {
        return sqlite.checkUserAccess(username, userRole, action, 4); // 4 = manager role
    }

    private void usersBtnActionPerformed(java.awt.event.ActionEvent evt) {
        if (checkManagerAccess(currentUsername, currentUserRole, "View Users")) {
            mgmtUser.init();
    ...
    private void productsBtnActionPerformed(java.awt.event.ActionEvent evt) {
        if (checkManagerAccess(currentUsername, currentUserRole, "View Products")) {
            mgmtProduct.init();
    ...
    private void historyBtnActionPerformed(java.awt.event.ActionEvent evt) {
        if (checkManagerAccess(currentUsername, currentUserRole, "View History")) {
            mgmtHistory.init();
            usersBtn.setForeground(Color.black);
            productsBtn.setForeground(Color.black);
